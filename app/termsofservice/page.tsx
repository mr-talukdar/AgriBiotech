...
const page = () => {
  return (
    <div>
      <h1>Welcome to AgriBiotech!</h1>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of our website, located at{" "}
        <a href="https://agribiotech.co.in/termsofservice">agribiotech.co.in</a>
        .
      </p>

      <p>
        By accessing this website, we assume you accept these terms and
        conditions. Do not continue to use AgriBiotech if you do not agree to
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By accessing agribiotech.co.in, you agreed
        to use cookies in agreement with AgriBiotech's Privacy Policy.
      </p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, AgriBiotech and/or its licensors own the
        intellectual property rights for all material on AgriBiotech. All
        intellectual property rights are reserved. You may access this from
        AgriBiotech for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from AgriBiotech</li>
        <li>Sell, rent or sub-license material from AgriBiotech</li>
        <li>Reproduce, duplicate or copy material from AgriBiotech</li>
        <li>Redistribute content from AgriBiotech</li>
      </ul>
      ...
      <h2>
        ...
        AgriBiotech does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of AgriBiotech, its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, AgriBiotech shall not be
      ...
      <p>
        AgriBiotech reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant AgriBiotech a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of AgriBiotech; and (d) the link
      ...
      <p>
        ...
        e-mail to AgriBiotech. Please include your name, your organization name,
      ...
      <p>
        No use of AgriBiotech's logo or other artwork will be allowed for
